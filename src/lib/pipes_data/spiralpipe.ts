const SpiralPipe = {
  ...
  variants: [
    ...
    },
    {
      ...
      diameter_availability: [
        ...
        { diameter_inch: "1", diameter_mm: 25, thickness_mm: [0.8, 1.0, 1.2] },
        {
          diameter_inch: "1 1/4",
          diameter_mm: 32,
          thickness_mm: [0.8, 1.0, 1.2],
        ...
        { diameter_inch: "2", diameter_mm: 50, thickness_mm: [0.8, 1.0, 1.2] },
        {
          diameter_inch: "2 1/2",
          diameter_mm: 63,
          thickness_mm: [0.8, 1.0, 1.2],
        },
        { diameter_inch: "3", diameter_mm: 76, thickness_mm: [0.8, 1.0, 1.2] },
      ],
    },
  ],
  description:
  ...
  notes: [
    "Standard variant supports thickness up to 1.5 mm.",
    "Economy variant supports thickness up to 1.2 mm.",
  ],
};

...
import { imagePath, imagePathForLanding } from "@/constants/imagePath";

type GallaryContentProps = {
  activeTab: string;
};
...
const galleryData: Record<string, any[]> = {
  ...
  "Product Images": [
    ...
    {
      id: "p16",
      img: "/images/products/spiral/spiral1.jpg",
      type: "image",
      height: 400,
    },
    ...
    {
      id: "p17",
      img: "/images/products/square/square1.jpg",
      type: "image",
      height: 500,
    },
    {
      id: "p18",
      img: "/images/products/square/square2.jpg",
      type: "image",
      height: 350,
    },
    {
      id: "p19",
      img: "/images/products/square/square3.jpg",
      type: "image",
      height: 450,
    },
  ],
...
const GallaryContent = ({ activeTab }: GallaryContentProps) => {
  ...
  return (
    <div className="w-full h-full flex-1 px-2 md:px-6 lg:px-12">
      <Masonry
        items={items}
        ease="power3.out"
        duration={0.6}

...
export default function ProductCategories() {
  return (
    <section
      id="products"
      className="relative border-t border-gray-200 bg-gray-50 py-10 sm:py-12 md:py-14 lg:py-16"
    >
      <div className="mx-auto container px-4 text-center sm:px-6 md:px-8 lg:px-12 xl:px-16">
        ...
        {/* Products Wrapper */}
        <div className="relative max-h-[620px] overflow-hidden sm:max-h-[760px] md:max-h-[820px] lg:max-h-[900px]">

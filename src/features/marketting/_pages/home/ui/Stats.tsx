...
const Stats = () => {
  return (
    <section className="relative py-12 border-t border-gray-200 bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-orange-500/5 blur-3xl rounded-full pointer-events-none" />
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-16 lg:px-24 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
          {importantStats.map((item, index) => (
            <div
              key={index}
              className="group rounded-2xl border border-gray-100 bg-white hover:shadow-xl transition-all duration-300 p-5 md:p-6"
            >
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 rounded-2xl bg-orange-100 text-orange-500 flex items-center justify-center shrink-0 group-hover:scale-110 transition">
                  {item.icon}
        ...
        <div className="mt-12 flex justify-center">
          <a
            href="/company-stats"
            className="inline-flex items-center gap-2 rounded-full bg-orange-500 px-7 py-3 text-white font-semibold shadow-lg hover:bg-orange-600 hover:shadow-xl transition-all duration-300"
          >
            See More

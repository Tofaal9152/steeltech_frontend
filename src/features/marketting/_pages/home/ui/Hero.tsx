  ...
  return (
    <div className="relative h-screen w-full overflow-hidden font-sans">
      ...
      <div className="relative z-10 mx-auto flex h-[calc(100vh-96px)] w-full max-w-350 flex-col justify-center px-6 md:px-16 lg:px-24">
        ...
        <button className="flex w-fit items-center bg-[#ed8c2f] px-8 py-3 text-sm uppercase text-white transition duration-200 shadow-[1px_1px_rgba(237,140,47),2px_2px_rgba(237,140,47),3px_3px_rgba(237,140,47),4px_4px_rgba(237,140,47),5px_5px_0px_0px_rgba(237,140,47)]">
